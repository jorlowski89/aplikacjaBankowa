...
CREATE TABLE Users (
    UserID INT IDENTITY(1,1) PRIMARY KEY,					-- Automatyczny UUID
...
CREATE TABLE Accounts (
    AccountID INT IDENTITY(1,1) PRIMARY KEY,					-- Automatyczny UUID
    ...
    UserID INT NOT NULL,										-- Powi¹zanie z u¿ytkownikiem (klucz obcy)
...
CREATE TABLE TransferTypes (
    TransferTypeID INT IDENTITY(1,1) PRIMARY KEY,			-- Automatyczny UUID
